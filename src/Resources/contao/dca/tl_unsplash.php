...
$GLOBALS['TL_DCA']['tl_unsplash'] = [
    ...
    'palettes' => [
        'default' => '{unsplash_filter_legend},unsplash_order_by,unsplash_orientation,unsplash_color,unsplash_content_filter',
    ],
    ...
    'fields' => [
        ...
        'unsplash_content_filter' => [
            ...
            //'reference' => &$GLOBALS['TL_LANG']['tl_unsplash']['options']['colors'],
            'eval' => ['chosen' => true, 'includeBlankOption' => true, 'tl_class' => 'w50'],
            'sql' => "varchar(255) NOT NULL default ''",
        ],
    ],
